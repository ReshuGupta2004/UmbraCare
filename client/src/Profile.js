...
const styles = {
  container: {
    ...
    boxSizing: 'border-box',
    paddingTop: '80px',
    backgroundImage: 'url(/background.jpg)', // Added background image from public folder
  ...
  input: {
    ...
    width: '100%',
    boxSizing: 'border-box',
    color: '#000000', // Text color consistent with others
  },
  readOnlyInput: {
    padding: '10px',
    fontSize: '16px',
  ...
  error: {
    fontSize: '16px',
    color: '#FF4444', // Slightly darker red for better visibility
    marginBottom: '20px',
  },
  success: {
    fontSize: '16px',
    color: '#4CAF50', // Kept green as it's standard for success
    marginBottom: '20px',
  },
};
