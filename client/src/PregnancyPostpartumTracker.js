    ...
    <div style={styles.container}>
      ...
      <div style={styles.trackerContainer}>
        ...
        <div style={styles.toggleContainer}>
          <button onClick={() => setMode('pregnancy')} style={{ ...styles.toggleButton, backgroundColor: mode === 'pregnancy' ? '#ff69b4' : '#ccc' }}>Pregnancy</button>
          <button onClick={() => setMode('postpartum')} style={{ ...styles.toggleButton, backgroundColor: mode === 'postpartum' ? '#ff69b4' : '#ccc' }}>Postpartum</button>
          <button onClick={() => setMode('medication')} style={{ ...styles.toggleButton, backgroundColor: mode === 'medication' ? '#ff69b4' : '#ccc' }}>Medication Reminder</button>
          <button onClick={() => setMode('menopause')} style={{ ...styles.toggleButton, backgroundColor: mode === 'menopause' ? '#ff69b4' : '#ccc' }}>Menopause Insights</button>
        </div>
