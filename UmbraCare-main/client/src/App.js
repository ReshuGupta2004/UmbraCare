        ...
        {showSplash ? (
          ...
          <>
            ...
            <Routes>
              ...
              {/* Corrected routes for model prediction */}
              <Route path="/form-component" element={isLoggedIn ? <FormComponent /> : <Navigate to="/" />} />
              <Route path="/results-page" element={isLoggedIn ? <ResultsPage /> : <Navigate to="/" />} />
              <Route path="/period-tracker/symptom-checker" element={isLoggedIn ? <ParentComponent /> : <Navigate to="/" />} />
            </Routes>
            {isLoggedIn && <Chatbot />}
          </>
        )}
